...
impl CompositionRoot {
    pub async fn new(mongo_uri: String) -> Self {
        ...
        let client_list_view: Arc<MongoViewRepository<ClientListView, Client>> =
            Arc::new(MongoViewRepository::new("group_list", client.clone()));
        ...
        let client_list_query = ListAllQuery::new(client_list_view.clone(), "client_list");
        ...
        let group_list_query = ListAllQuery::new(group_list_view.clone(), "group_list");
